...
The above parser has a parsing rule that extracts the names and saves them as records. The syntax of these rules is inspired by the AWK programming language and is described in L<Text::Parser::ExAWK::Manual>.
