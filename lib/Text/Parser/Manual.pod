...
There are several problems with this sort of code:
...
* L<Text::Parser::Manual::ManagingComplexRules> - what if you have a complex text file and need to write several rules? What options do you have?
* L<Text::Parser::Manual::CommunicatingBetweenRules> - using parser attributes to communicate between rules
